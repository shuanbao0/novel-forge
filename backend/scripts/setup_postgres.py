...
class PostgreSQLSetup:
    ...
    def __init__(
        ...
        db_name: str = "novel_forge",
        db_user: str = "novelforge",
...
╚═══════════════════════════════════════════════════════════════╝
    ...
    print("\n请输入要创建的数据库信息:\n")
    db_name = input("数据库名 [novel_forge]: ").strip() or "novel_forge"
    db_user = input("数据库用户名 [novelforge]: ").strip() or "novelforge"
    db_password = getpass("数据库用户密码 [novelforge123]: ") or "novelforge123"
