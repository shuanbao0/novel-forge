...
class Settings(Base):
    ...
    # AI 配置：所有字段必须由用户在前端「系统设置」中显式填写，不存在系统级默认；
    # 数据库层允许 NULL，避免与"未配置"状态混淆。
    ...
    smtp_from_name = Column(String(255), default="novel-forge", server_default="novel-forge", nullable=False, comment="发件人名称")
